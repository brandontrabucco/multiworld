...
class MazeEnv(gym.Env, Serializable):
    ...
    def reset(self):
        ...
        return {"proprio_observation": self._get_obs()}
    ...
    def observation_space(self):
        ...
        low = -high
        return gym.spaces.Dict({"proprio_observation": gym.spaces.Box(low, high)})
    ...
    def step(self, action):
        ...
        return {"proprio_observation": next_obs}, inner_reward, done, info
